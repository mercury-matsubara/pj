			...
			if(filename == 'PROGRESSINFO_1')
			{
				...
				else
				{
					...
					document.getElementById('form_303_0').style.backgroundColor = '';
                                ...
                                if(teizi % 25 != 0)
                                {
                                        window.alert('定時時間は15分刻みで入力してください。');
					judge = false;
                                }
                                if(zangyou % 25 != 0)
                                {
                                        window.alert('残業時間は15分刻みで入力してください。');
					judge = false;
                                }
...
<?php
	...
	echo "</tr></table>";
        if($filename == 'PJTOUROKU_1')
	{
                echo "<table><tr><td class='space' style='width: 137px;'></td><td class='one' style='width: 154px;'><a class='itemname'>合計金額 : </a></td>";
