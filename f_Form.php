...
function makeformModal_set($post,$isReadOnly,$form_Name,$columns){
    ...
    if(isset($_SESSION["tablenum"]))
    {
        if($_SESSION["tablenum"] == "5" && $form_Name == "form" && $filename != "PROGRESSINFO_2")
        {
            $form_name = "period";
            $over = "";
            $form_str .= "<tr><td>期</td><td>";
        ...
        if($_SESSION["tablenum"] == "6" && $form_Name == "form" && ($filename == "PROGRESSINFO_2" || $filename == "PROGRESSINFO_1"))
        {
            $form_name = "period";
            $over = "";
            $form_str .= "<tr><td>期</td><td>";
...
function makePROGRESSlist($post="")
{
    ...
    for($i = 0 ; $i < 10 ; $i++)
    {
            ...
            if(isset($post['6CODE_'.$i]))
            {
                $list_html .= "<input type ='hidden' name ='7CODE_".$i."' id ='7CODE_".$i."'' value ='".$post['7CODE_'.$i]."' >";
            ...
            {
                $list_html .= "<input type ='hidden' name ='7CODE_".$i."'' id ='7CODE_".$i."'' value ='' >";
